...
bool Shader::linkProgram(GLuint computeShader, const char *name)
{
...
bool Shader::linkProgram(GLuint vertexShader, GLuint geometryShader, GLuint fragmentShader, const char *name)
{
	GLuint program = glCreateProgram();
