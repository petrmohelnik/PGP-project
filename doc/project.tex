...
Klidovou hustotu $\rho_0$ uva¾ujeme $0.59$ a hmotnost $m$ jedné èástice $0.00005$. Radius $h = 0.06$ je urèen, aby do nìj spadalo asi 12 èástic, dále $k = 4$, $\mu = 0.01$ a $b = 5$. Tyto hodnoty jsou pøevzaty z \cite{kelager06}, kde jsou urèeny pomocí fyzikálních vztahù pro objem, hustotu, hmotnost aj. Hodnota $k$ není fyzikálnì pøesná, proto¾e by simulace dobøe nefungovala s tak velikou hodnotou. To jak dobøe tato hodnota bude fungovat je závislé na mno¾ství èástic.  
